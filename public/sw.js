...
self.addEventListener("push", (event) => {
  ...
  // ReiStandard payloads are handled by offline-push-sw.js. Do not let the
  // personal-push listener render the same message a second time.
  if (data && typeof data === "object" && data.messageKind) return;
